...
from PyQt5.QtWidgets import (
    ...
    QPushButton, QLabel, QVBoxLayout, QLineEdit, QHBoxLayout)
...
class FinalWindow(QWidget):
    ...
    def results(self):
        if self.exp.age < 7:
            self.index = 0
            return "sorry! There is no data for this age"
        
        self.total_test = int(self.exp.test1) + int(self.exp.test2) + int(self.exp.test3)
        self.index = (4 * self.total_test - 200) /10
